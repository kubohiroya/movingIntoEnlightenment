...
mieVideoHSVConv::mieVideoHSVConv(const int cameraIndex, const float ox, const float oy, const int width, const int height, ofVideoGrabber * ofVideoGrabber):mieVideoPixelSource(cameraIndex, ox, oy, width, height, ofVideoGrabber){
};
